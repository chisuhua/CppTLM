...
| [ADR-X.15-cpptlm-v3-dgpu-extract.md](../docs-archived/adr/ADR-X.15-cpptlm-v3-dgpu-extract.md) | cpptlm-v3-dgpu-extract (角色反转 + v3.0.0 BREAKING bump + 11 项物理删除清单, HSK-6 P0-1 门禁已完成 `fa2b3ec`)**— 🚫 2026-08-19 归档至 `docs-archived/adr/`(被 ADR-X.17 MVP 切片取代 + Status Update 审计追溯保留)** | 🚫 Archived | Phase 9 (W1-9) |
| [ADR-X.16-cpptlm-v05-redo.md](../docs-archived/adr/ADR-X.16-cpptlm-v05-redo.md) | cpptlm-v05-redo (Net-new 取代 v3.0-extract,PTX-EMU submodule + adapter + per-warp instruction precision,8 项决策锁定, 反转 ADR-X.15 决策清单)**— 🚫 2026-08-19 归档至 `docs-archived/adr/`(被 ADR-X.17 MVP 切片取代,8 项决策作为 MVP 决策依据)** | 🚫 Archived | Phase 10 (W1-12) |
| [ADR-X.17-cpptlm-v05-mvp.md](./ADR-X.17-cpptlm-v05-mvp.md) | cpptlm-v05-mvp (**MVP 切片**:UsrLinuxEmu IOCTL → CppTLM CP→TMU→Cuda Core → PTX-EMU warp,4 阶段 6-10 周,沿用 ADR-X.16 决策) | 📋 Proposed | Phase 10 MVP (W1-10) |
