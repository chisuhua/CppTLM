...
| 2 | **内存子系统** | 2 | 2 | 调研 §2.2 | [`memory-memtlm.md`](./memory-memtlm.md) [`memory-simple.md`](./memory-simple.md) [`memory-dram.md`](./memory-dram.md) [`memory-hbm.md`](./memory-hbm.md) [`memory-qos.md`](./memory-qos.md) | ✅ (v0) / 🟡 4 (B3.4.1) |
...
| 5 | **GPU / GPGPU** | 1 | 5 | 调研 §2, §4 Phase 7.A-F | [`gpu-gputlm.md`](./gpu-gputlm.md) [`gpu-tcc.md`](./gpu-tcc.md) [`gpu-pcie_bridge.md`](./gpu-pcie_bridge.md) | ✅ (v0 1/3) / 🟡 2 个 (B3.5.1) — SM 重构后 kernel-launch/compute-unit/common 已被 [architecture/15-sm-microarchitecture-design.md](../../architecture/15-sm-microarchitecture-design.md) §15.3 (12 ChStream 子模块 + IComputeDevice 15 方法) 取代 |
| 5b | **GPU / dGPU MVP 切片** (per [ADR-SOC-06](../../adr/ADR-SOC-06-cpptlm-v05-mvp.md)) | 5 | 0 | ADR-SOC-06 + v0.4 设计 | [`command-processor.md`](./command-processor.md) [`pm4-decoder.md`](./pm4-decoder.md) [`tmu-dispatch-processor.md`](./tmu-dispatch-processor.md) [`submit-queue.md`](./submit-queue.md) [`completion-ring.md`](./completion-ring.md) | 🔵 Implemented (W2 board-soc-split + W3.2 abi-export) — cuda-core-adapter/ptx-emu-submodule-mvp/dgpu-board 已 superseded (per [ADR-SOC-16](../../adr/ADR-SOC-16-sm-microarchitecture.md), Task 12) |
...
| `CudaCoreAdapterMVP` | ~~`include/tlm/gpu/cuda_core_adapter_mvp.hh`~~ | `tlm` | ~~HSK-8 timing adapter (init 注入 3 timing 模块)~~ | (已删除 per Task 12) | ❌ **Deprecated** → superseded by `IComputeDevice` (per [ADR-SOC-16](../../adr/ADR-SOC-16-sm-microarchitecture.md)) |
| `PtxEmuSubmoduleMVP` | ~~`include/tlm/gpu/ptx_emu_submodule_mvp.hh`~~ | `tlm::gpu` | ~~PTX functional facade (HSK-8)~~ | (已删除 per Task 12) | ❌ **Deprecated** → superseded by `IComputeDevice::set_instr_descriptor_buf` |
