...
| 5b | **GPU / dGPU MVP 切片** (per [ADR-X.17](../../adr/ADR-X.17-cpptlm-v05-mvp.md)) | 0 | 6 | ADR-X.17 + v0.4 设计 | [`dgpu-board.md`](./dgpu-board.md) [`command-processor.md`](./command-processor.md) [`pm4-decoder.md`](./pm4-decoder.md) [`tmu-dispatch-processor.md`](./tmu-dispatch-processor.md) [`cuda-core-adapter.md`](./cuda-core-adapter.md) [`ptx-emu-submodule-mvp.md`](./ptx-emu-submodule-mvp.md) | 🟡 (MVP 4 阶段 6-10 周) |
