...
> **关联总架构蓝图**: [`docs/soc_arch/architecture/00-overview.md`](../architecture/00-overview.md) v3.1 PASS（§3.6 L6 SM/CU 内核层）
> **关联现有模块微架构**:
...
本文档**严格对齐** `00-overview.md` v3.1 PASS 的 §3.6 L6 SM/CU 内核层 + §4-bis 范围矩阵 R05-R06 + §6.1 兼容性分析。
