...
// =============================================================================
TEST_CASE_METHOD(TestRig, "CudaCoreAdapterMVP: init() creates 4 timing modules and sets flag",
                 "[gpu][hsk8][timing]") {
...
// =============================================================================
TEST_CASE_METHOD(TestRig, "CudaCoreAdapterMVP: init() is idempotent (no module recreation)",
                 "[gpu][hsk8][timing]") {
...
// =============================================================================
TEST_CASE_METHOD(TestRig, "CudaCoreAdapterMVP: scoreboard implements IScoreboard (HSK-4 PTX-1)",
                 "[gpu][hsk8][timing]") {
...
// =============================================================================
TEST_CASE_METHOD(TestRig, "CudaCoreAdapterMVP: facade->sm_exe_once() runs after timing injection",
                 "[gpu][hsk8][timing][e2e]") {
