...
TEST_CASE("Axi4Mapper: outstanding independent read/write ID spaces", "[axi][mapper][outstanding]") {
...
TEST_CASE("Axi4Mapper: complete non-existent ID returns false, no consume", "[axi][mapper][outstanding]") {
    Axi4Mapper mapper(4);
