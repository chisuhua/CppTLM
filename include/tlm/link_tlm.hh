...
public:
    ...
    std::string get_module_type() const override { return "LinkTLM"; }
    ...
    // ========== 端口访问器 ==========
    cpptlm::InputStreamAdapter<bundles::NoCFlitBundle>& req_in() { return req_in_; }
    cpptlm::OutputStreamAdapter<bundles::NoCFlitBundle>& resp_out() { return resp_out_; }
