...
范围:
- 架构文档迁移：`umbrella/design.md` → `docs/soc_arch/architecture/19-pcie-ip-microarchitecture.md`
...
- **WHEN** 读取 `docs/soc_arch/architecture/19-pcie-ip-microarchitecture.md`
