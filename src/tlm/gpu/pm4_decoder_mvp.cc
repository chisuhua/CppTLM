...
//
// Pm4MethodHeader 是 32-bit bitfield (inc:1, method_addr:15, subchannel:4, data_count:4,
// reserved:8)
...
namespace tlm::gpu {
    ...
    Pm4MethodDispatch Pm4Decoder::parse_method(uint32_t method_header, const uint32_t* payload,
                                               uint32_t max_dwords) {
